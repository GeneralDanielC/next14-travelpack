            ...
            <CardContent className="overflow-y-scroll max-h-full">
                ...
                <Tabs defaultValue="subscription">
                    <TabsList className="w-full">
                        <TabsTrigger value="subscription" className="w-full">Subscription</TabsTrigger>
                        <TabsTrigger value="account" className="w-full">Account</TabsTrigger>
                    </TabsList>
                    <TabsContent value="subscription" className="pt-4">
                        <div className="flex flex-col bg-accent p-5 rounded-xl w-full space-y-2">
                            ...
                            <div className=" grid grid-cols-1 md:grid-cols-2 gap-3 justify-center">
                                ...
                                <div className={cn("flex flex-col w-full p-2 rounded-xl hover:border-2 5 border-accent-foreground transition-all duration-50",
                                    ...
                                    <div className="flex flex-col p-2 gap-y-0.5">
                                        <div className="flex flex-row items-center gap-x-2">
                                            <Check className="size-5" />
                                            <span className="text-xs">Everything in the free plan</span>
                                        </div>
                                        <div className="flex flex-row items-center gap-x-2">
                                            <Check className="size-5" />
                                        ...
                                        <div className="flex flex-row items-center gap-x-2">
                                            <Check className="size-5" />
                                            <span className="text-xs">More is coming!</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
